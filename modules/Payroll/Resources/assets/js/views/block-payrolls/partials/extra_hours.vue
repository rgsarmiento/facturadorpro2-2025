                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <table>
                            <thead>
                                <tr width="100%">
                                    <template v-if="form.accrued.heds && form.accrued.heds.length>0">
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <table>
                            <thead>
                                <tr width="100%">
                                    <template v-if="form.accrued.hens && form.accrued.hens.length>0">
                                        <th class="pb-2">Fecha</th>
                                        <th class="pb-2">Hora inicio - Hora término</th>
                                        <th class="pb-2">Cantidad</th>
                                        <th class="pb-2">Pago</th>
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <table>
                            <thead>
                                <tr width="100%">
                                    <template v-if="form.accrued.hrns && form.accrued.hrns.length>0">
                                        <th class="pb-2">Fecha</th>
                                        <th class="pb-2">Hora inicio - Hora término</th>
                                        <th class="pb-2">Cantidad</th>
                                        <th class="pb-2">Pago</th>
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <table>
                            <thead>
                                <tr width="100%">
                                    <template v-if="form.accrued.heddfs && form.accrued.heddfs.length>0">
                                        <th class="pb-2">Fecha</th>
                                        <th class="pb-2">Hora inicio - Hora término</th>
                                        <th class="pb-2">Cantidad</th>
                                        <th class="pb-2">Pago</th>
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <table>
                            <thead>
                                <tr width="100%">
                                    <template v-if="form.accrued.hrddfs && form.accrued.hrddfs.length>0">
                                        <th class="pb-2">Fecha</th>
                                        <th class="pb-2">Hora inicio - Hora término</th>
                                        <th class="pb-2">Cantidad</th>
                                        <th class="pb-2">Pago</th>
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <table>
                            <thead>
                                <tr width="100%">
                                    <template v-if="form.accrued.hendfs && form.accrued.hendfs.length>0">
                                        <th class="pb-2">Fecha</th>
                                        <th class="pb-2">Hora inicio - Hora término</th>
                                        <th class="pb-2">Cantidad</th>
                                        <th class="pb-2">Pago</th>
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <table>
                            <thead>
                                <tr width="100%">
                                    <template v-if="form.accrued.hrndfs && form.accrued.hrndfs.length>0">
                                        <th class="pb-2">Fecha</th>
                                        <th class="pb-2">Hora inicio - Hora término</th>
                                        <th class="pb-2">Cantidad</th>
                                        <th class="pb-2">Pago</th>
...
import moment from 'moment'
    export default {
        ...
        methods: {
            ...
            create() {
                // Inicializar arrays de horas extras si no existen
                if (!this.form.accrued.heds) {
                    this.$set(this.form.accrued, 'heds', []);
                }
                if (!this.form.accrued.hens) {
                    this.$set(this.form.accrued, 'hens', []);
                }
                if (!this.form.accrued.hrns) {
                    this.$set(this.form.accrued, 'hrns', []);
                }
                if (!this.form.accrued.heddfs) {
                    this.$set(this.form.accrued, 'heddfs', []);
                }
                if (!this.form.accrued.hrddfs) {
                    this.$set(this.form.accrued, 'hrddfs', []);
                }
                if (!this.form.accrued.hendfs) {
                    this.$set(this.form.accrued, 'hendfs', []);
                }
                if (!this.form.accrued.hrndfs) {
                    this.$set(this.form.accrued, 'hrndfs', []);
                }
                if (typeof this.form.accrued.total_extra_hours === 'undefined') {
                    this.$set(this.form.accrued, 'total_extra_hours', 0);
                }
            },
            clickClose() {
