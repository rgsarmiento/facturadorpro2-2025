<template>
    <div class="card mb-0 pt-2 pt-md-0">
        <div class="card-header bg-primary">
            <h4 class="mb-0 text-white"><i class="fas fa-file-invoice-dollar"></i> Nuevo Gasto</h4>
        </div>
        <div class="card-body">
            <form autocomplete="off" @submit.prevent="submit">
                <div class="invoice-form">
                    ...
                    <!-- Sección 2: Proveedor y Motivo -->
                    <div class="form-section">
                        <div class="section-header">
                            <i class="fas fa-user-tie"></i>
                            <span>Proveedor y Motivo</span>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th width="40%">Detalle del gasto</th>
                    ...
                    <!-- Sección 4: Detalles y Conceptos -->
                    <div class="form-section">
                        <div class="section-header">
                            <i class="fas fa-list-ul"></i>
                            <span>Detalles y Conceptos</span>
                        </div>
                        <div class="row">
                ...
                <div class="form-actions text-right mt-4">
                    ...
                    <el-button type="primary" native-type="submit" :loading="loading_submit" v-if="form.items.length > 0">
