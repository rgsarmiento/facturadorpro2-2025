                        ...
                        <div class="form-group">
                            ...
                            >
                                <el-option
                                    ...
                                    :key="option.id"
                                    :value="option.id"
                                    :label="formatDocumentTypeLabel(option)"
                                ></el-option>
                            </el-select>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        formatDocumentTypeLabel(option) {
            // Función para formatear la etiqueta del tipo de documento
            const parts = [];

            if (option.description) parts.push(option.description);
            if (option.prefix) parts.push(option.prefix);
            if (option.resolution_number) parts.push(option.resolution_number);
            if (option.from && option.to)
                parts.push(`${option.from}-${option.to}`);
