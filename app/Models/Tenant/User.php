...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'establishment_id', 'type', 'prefix', 'locked', 'active', 'identity_document_type_id', 'number', 'address', 'telephone', 'fe_resolution_id', 'nc_resolution_id', 'nd_resolution_id', 'ni_resolution_id',
    ];
