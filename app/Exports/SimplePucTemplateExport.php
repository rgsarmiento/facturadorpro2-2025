...
class SimplePucTemplateExport implements FromArray, WithHeadings
{
    public function array(): array
    {
        // Datos de ejemplo más simples para Excel 2007
        return [
            ...
            ['1435', 'MERCANCÍAS NO FABRICADAS', 'activo', 'debito', 3, '14', 'Productos para la venta no fabricados', 1, 1, 0],
            ...
            ['1528', 'EQUIPO DE COMPUTACIÓN', 'activo', 'debito', 3, '15', 'Computadores y equipos de comunicación', 1, 1, 0],
            ...
            ['4135', 'COMERCIO AL POR MAYOR Y MENOR', 'ingreso', 'credito', 3, '41', 'Ventas de mercancías', 1, 1, 0],
            ...
            ['61', 'COSTO DE VENTAS Y SERVICIOS', 'costo', 'debito', 2, '6', 'Costo de productos vendidos', 1, 0, 0],
            ['6135', 'COMERCIO AL POR MAYOR Y MENOR', 'costo', 'debito', 3, '61', 'Costo de mercancías vendidas', 1, 1, 0]
        ];
    }
