...
<script>
    ...
    new Vue({
        ...
        data() {
            return {
                asientoData: {{ isset($asiento) ? $asiento->toJson() : 'null' }},
                isEditing: {{ isset($asiento) ? 'true' : 'false' }},
                        form: {
                            tipo_comprobante_id: '',
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="balance-info" 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <span v-text="formatCurrency(totalDebito)"></span>
                                        </div>
                                        <div class="col-md-6">
                                            <strong>Total Créditos:</strong><br>
                                            <span v-text="formatCurrency(totalCredito)"></span>
                                        </div>
                                    </div>
                                    <hr class="my-2">
                                    <div class="text-center">
                                        <strong v-if="estaBalanceado" class="text-success">
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        Máximo 5MB por archivo. Formatos: PDF, JPG, PNG, DOC, XLS
                                    </small>
                                </div>
                                ...
                                <div v-if="adjuntosExistentes.length > 0" class="adjuntos-preview">
                                    ...
                                    <div v-for="adjunto in adjuntosExistentes" 
                                        ...
                                        <div>
                                            ...
                                            <span v-text="adjunto.nombre_archivo"></span>
