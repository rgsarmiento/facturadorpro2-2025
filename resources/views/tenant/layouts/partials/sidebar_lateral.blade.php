                    ...
                    <li class="
                        ...
                        <ul class="nav nav-children" style="">
                            ...
                            <li class="{{(($path[0] === 'contabilidad') && ($path[1] === 'periodos-contables')) ? 'nav-active' : ''}}">
                                <a class="nav-link" href="{{ route('tenant.periodos_contables.index') }}">
                                    <i class="fas fa-calendar-alt" aria-hidden="true"></i>
                                    Períodos Contables
                                </a>
                            </li>
                            <li class="{{(($path[0] === 'contabilidad') && ($path[1] === 'saldos-iniciales')) ? 'nav-active' : ''}}">
                                <a class="nav-link" href="{{ route('tenant.saldos_iniciales.index') }}">
                            ...
                            <li class="{{(($path[0] === 'contabilidad') && ($path[1] === 'reportes-contables')) ? 'nav-active' : ''}}">
                                <a class="nav-link" href="{{ route('tenant.reportes_contables.index') }}">
